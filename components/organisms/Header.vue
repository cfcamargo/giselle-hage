<template>
  <header class="h-[80px] flex items-center justify-between shadow fixed top-0 bg-primary w-full z-50 px-8"
    ...
    <div v-show="submenu" class="absolute left-0 right-0 top-[70px] pt-4 flex justify-center items-center">
